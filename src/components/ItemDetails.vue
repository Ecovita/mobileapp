    ...
    <q-card class="rounded-borders-top">
      ...
      <DIV v-else class="q-pl-md q-pr-md q-pb-sm q-pt-md">
        <div class="row items-start q-gutter-sm q-mb-sm">
			...
			<div v-if="this.gallery.length >0">
			
			
           <div style="float:left;height:auto;max-width: 96%;width: 96%;position: absolute; opacity: 0;"
		   v-if="this.gallery"
            class="q-gutter-sm row items-start"
          >
            <template
              v-for="(items, index) in this.gallery"
              :key="items"
            >
              <template v-if="index<1">
                <q-img
                  ...
                  spinner-color="secondary"
                  spinner-size="sm"
                  style="height:300px;    position: absolute;width:96%"
			 ...
			 <ImagePreview ref="imagePreview" :gallery="this.gallery_images" title=""></ImagePreview>
      ...
      APIinterface.getMenuItem(
        ...
        .then((data) => {
          ...
          this.if_sold_out = data.details.default_sold_out_options;
		    ...
		    this.gallery = data.details.gallery;
        ...
        this.total=(this.gallery).length;
		 ...
		 let Gallery = [];
          if (Object.keys(this.gallery).length > 0) {
            Object.entries(this.gallery).forEach(([key, items]) => {
