              ...
              <q-item clickable>
                <q-card flat class="fit radius8">
                  <q-card-section
                    ...
                    @click.stop="showQuickDetails(order)"
                  >
    ...
    NodataMessage() {
      if (this.is_search) {
        ...
        if (this.order_tab == "all") {
          return "У вас здесь нет заказов!";
        } else {
          return "Без результатов";
        }
      }
    },
    NodataMessage2() {
      ...
      APIinterface.fetchDataByTokenPost(
        ...
        .then((data) => {
          if (data.details.show_next_page == false && index > 1) {
            ...
            this.status_allowed_review =
              data.details.data.status_allowed_review;
